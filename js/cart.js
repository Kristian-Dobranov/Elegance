  ...
  $('.colors-large a').click(function(){return false;});
	...
	$('.add-cart-large').each(function(i, el){
		$(el).click(function(){
			...
			var cartItem = "<div class='cart-item'><div class='img-wrap'><img src='"+img.src+"' alt='' /></div><span>"+productName+"</span><strong>"+product_price+"</strong><div class='cart-item-border'></div><div class='delete-item'></div></div>";			
